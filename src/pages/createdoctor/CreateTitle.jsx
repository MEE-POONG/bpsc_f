          ...
          <div className="box-sheare detail">
            <Row>
              <Col md="6">
                <div className="header">
                  <Form.Group controlId="formBasicEmail">
                    <Form.Label>ชื่อจริง({sharingData.title.length}/50)</Form.Label>
                    <Form.Control
                      type="text"
              ...
              <Col md="6">
                <div className="header">
                  <Form.Group controlId="formBasicEmail">
                    <Form.Label>นามสกุล({sharingData.title.length}/50)</Form.Label>
                    <Form.Control
                      type="text"
                      placeholder="ชื่อแชร์"
                      onChange={(e) => {
              ...
              <Col md="6">
                <div className="header">
                  <Form.Group controlId="formBasicEmail">
                    <Form.Label>E mail({sharingData.title.length}/50)</Form.Label>
                    <Form.Control
                      type="text"
                      placeholder="ชื่อแชร์"
                      onChange={(e) => {
              ...
              <Col md="6">
                <div className="header">
                  <Form.Group controlId="formBasicEmail">
                      <Form.Label>Phone({sharingData.title.length}/50)</Form.Label>
                      <Form.Control
                        type="text"
                      placeholder="ชื่อแชร์"
                      onChange={(e) => {
              ...
              <Col md="6">
                <div className="header">
                  <Form.Group controlId="formBasicEmail">
                      <Form.Label>content({sharingData.title.length}/50)</Form.Label>
                      <Form.Control
                        type="text"
                      placeholder="ชื่อแชร์"
                      onChange={(e) => {
              ...
              <Col md="6">
                <div className="header">
                  <Form.Group controlId="formBasicEmail">
                      <Form.Label>hospital({sharingData.title.length}/50)</Form.Label>
                      <Form.Control
                        type="text"
                      placeholder="ชื่อแชร์"
                      onChange={(e) => {
